...
x_train, y_train = get_sentiment_batch(data, 0, 1008) #1008  #506


# dev data
# data = build_sentiment_dataset_from_xml('datasets/intertass-development-tagged.xml')
# x_dev, y_dev = get_sentiment_batch(data, 0, 506) #1008  #506
...
x_test, y_test = get_sentiment_batch(data, 0, 1899)  #1899



# validation data
# data = build_sentiment_dataset_from_xml('datasets/intertass-development-tagged.xml')
# x_test, y_test = get_sentiment_batch(data, 0, 506)  #returns 501
